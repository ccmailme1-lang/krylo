...
// WO-256 — Campaign funnel: krylo-feed.html in iframe
...
export default function CampaignFunnel({ signals, records, iframeRef: externalRef, src = '/krylo-feed.html', onCat, onProxy }) {
