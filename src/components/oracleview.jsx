...
import { normalizeToOracleSignal } from "../engine/oraclesignal.js";
...
function Oracleview({ query, data, signalMapData, lens, onLensSwitch, categoryContext, onReturn, hostPayload }) {
  ...
  const title   = query || data?.title || "Awaiting Signal...";
  ...
  const oracleSignal = useMemo(() => normalizeToOracleSignal(data, { applyHysteresis: true }), [data]);
