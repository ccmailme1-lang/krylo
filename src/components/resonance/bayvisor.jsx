...
function AlertsMode({ isPremium }) {
  ...
  if (!isPremium) {
    return (
      <div style={{ position: 'relative', flex: 1, display: 'flex', alignItems: 'center', padding: '0 10px' }}>
        <div style={{ filter: 'blur(2px)', fontFamily: MONO, fontSize: 8, color: DIM, pointerEvents: 'none' }}>
          when signal exceeds...
        </div>
        <div style={{
          ...
          <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.2em' }}>ALERTS</span>
          <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, border: '1px solid rgba(102,255,0,0.35)', padding: '2px 8px', letterSpacing: '0.16em', cursor: 'pointer' }}>
            UPGRADE
          </span>
        </div>
      </div>
  ...
  return (
    <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 6, padding: '0 10px' }}>
      {trigger ? (
        <>
          <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', letterSpacing: '0.08em' }}>● {trigger}</span>
          <button onClick={e => { e.stopPropagation(); setTrigger(null); }}
            style={{ background: 'none', border: 'none', color: 'rgba(255,60,60,0.7)', fontFamily: MONO, fontSize: 8, cursor: 'pointer', letterSpacing: '0.1em' }}>CLEAR</button>
        </>
      ) : (
        <input value={input} onChange={e => setInput(e.target.value)}
          ...
          style={{ flex: 1, background: 'transparent', border: 'none', borderBottom: '0.5px solid rgba(255,255,255,0.12)', outline: 'none', color: MID, fontFamily: MONO, fontSize: 8, letterSpacing: '0.06em' }}
        />
      )}
    </div>
  );
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '6px 10px 8px', gap: 6 }}>
              ...
              <div style={{ flex: 1, display: 'flex', alignItems: 'stretch', minHeight: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
                  <span style={{ fontFamily: MONO, fontSize: 44, lineHeight: 0.85, color, letterSpacing: '-0.04em' }}>{pct}</span>
                  <span style={{ fontFamily: MONO, fontSize: 12, color, opacity: 0.6, lineHeight: 0.85, alignSelf: 'flex-end', marginBottom: 6 }}>%</span>
                  <div style={{ display: 'flex', flexDirection: 'column', marginLeft: 8, gap: 2 }}>
                    <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em', lineHeight: 1.3 }}>SIGNAL</span>
                    <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em', lineHeight: 1.3 }}>SCORE</span>
                  </div>
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ flex: 1, marginLeft: 10, paddingLeft: 10, borderLeft: '0.5px solid rgba(255,255,255,0.09)', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 6 }}>
                      <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.16em', lineHeight: 1.4 }}>{m.label}</span>
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: 3 }}>
                        <span style={{ fontFamily: MONO, fontSize: 16, color, letterSpacing: '-0.02em', lineHeight: 1 }}>{m.value}</span>
                        {m.unit && <span style={{ fontFamily: MONO, fontSize: 8, color: DIM }}>{m.unit}</span>}
                      </div>
                    </div>
                  );
                })()}
              ...
              <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                ...
                <div style={{ flex: 1, border: '0.5px solid rgba(255,255,255,0.09)', padding: '6px 8px', display: 'flex', flexDirection: 'column', gap: 4 }}>
                  <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em' }}>VELOCITY</span>
                  {t.length > 1 ? (() => {
                  ...
                  })() : <span style={{ fontFamily: MONO, fontSize: 8, color: DIM }}>—</span>}
                </div>

                <div style={{ flex: 1, border: '0.5px solid rgba(255,255,255,0.09)', padding: '6px 8px', display: 'flex', flexDirection: 'column', gap: 4 }}>
                  <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em' }}>24H TREND</span>
                  {t.length > 1 ? (() => {
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 14px', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
                ...
                <span style={{ fontFamily: MONO, fontSize: 10, color: BRT }}>
                  {velocity ?? '—'}<span style={{ fontSize: 8, color: DIM, marginLeft: 2 }}>pts/tick</span>
                </span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.20em' }}>TREND</span>
                <span style={{ fontSize: 12, lineHeight: 1, color: trendUp === null ? DIM : trendUp ? LIME : '#FF3B3B' }}>
              ...
              <div style={{ flex: 1, minHeight: 0, padding: '4px 8px 0' }}>
                {trend.length > 1 ? (() => {
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                    <span style={{ fontFamily: MONO, fontSize: 8, color: DIM }}>NO DATA</span>
                  </div>
                )}
              </div>
              ...
              <div style={{ flexShrink: 0, display: 'flex', justifyContent: 'space-between', padding: '6px 10px', borderTop: '0.5px solid rgba(255,255,255,0.12)' }}>
                {[
                  ...
                  <div key={label} style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.14em' }}>{label}</span>
                    <span style={{ fontFamily: MONO, fontSize: 10, color: BRT }}>{value}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          return (
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ flexShrink: 0, padding: '6px 10px 8px', display: 'flex', flexDirection: 'column', gap: 5, borderTop: '0.5px solid rgba(255,255,255,0.07)' }}>
                <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em' }}>TRUST PROGRESS BAR</span>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                  <span style={{ fontFamily: MONO, fontSize: 8, color: DIM, letterSpacing: '0.18em' }}>VALIDATED TIER</span>
                  <span style={{ fontFamily: MONO, fontSize: 8, color: tierColor, letterSpacing: '0.16em' }}>{tier}</span>
                </div>
              </div>
            </div>
          );
  ...
  return (
    <div style={{
      ...
      <div onClick={onToggle} style={{
        ...
        <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, letterSpacing: '0.22em', flexShrink: 0 }}>{d.id}</span>
        <span
      ...
      <div style={{
        ...
        <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, letterSpacing: '0.2em' }}>{d.id}</span>
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <button onClick={e => cycleModule(-1, e)}
            style={{ background: 'none', border: 'none', color: LIME, cursor: 'pointer', fontFamily: MONO, fontSize: 10, padding: '0 2px', lineHeight: 1 }}>{'<'}</button>
          <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, letterSpacing: '0.18em', textTransform: 'uppercase', minWidth: 72, textAlign: 'center' }}>
            {activeModule ?? 'HEADLINE'}
          </span>
          <button onClick={e => cycleModule(1, e)}
            style={{ background: 'none', border: 'none', color: LIME, cursor: 'pointer', fontFamily: MONO, fontSize: 10, padding: '0 2px', lineHeight: 1 }}>{'>'}</button>
        </div>
        <span style={{ fontFamily: MONO, fontSize: 8, color: LIME, letterSpacing: '0.2em' }}>SYNCED</span>
      </div>
    </div>
  );
}
